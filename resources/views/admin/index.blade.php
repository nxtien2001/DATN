            ...
            <div class="widget widget-account-invoice-three">
                ...
                <div class="widget-heading">
                    <div class="wallet-usr-info">
                        <div class="usr-name">
                            <span><img src="{{asset('backend/assets/img/profile-32.jpg')}}" alt="admin-profile" class="img-fluid"> Alan Green</span>
                        </div>
                        <div class="add">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="td-content customer-name"><img src="{{asset('backend/assets/img/profile-13.jpg')}}" alt="avatar"><span>Luke Ivory</span></div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content customer-name"><img src="{{asset('backend/assets/img/profile-7.jpg')}}" alt="avatar"><span>Andy King</span></div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content customer-name"><img src="{{asset('backend/assets/img/profile-10.jpg')}}" alt="avatar"><span>Laurie Fox</span></div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content customer-name"><img src="{{asset('backend/assets/img/profile-5.jpg')}}" alt="avatar"><span>Ryan Collins</span></div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content customer-name"><img src="{{asset('backend/assets/img/profile-4.jpg')}}" alt="avatar"><span>Irene Collins</span></div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content customer-name"><img src="{{asset('backend/assets/img/profile-11.jpg')}}" alt="avatar"><span>Sonia Shaw</span></div>
                                    </td>
                                    <td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-scroll">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="td-content product-name"><img src="{{asset('backend/assets/img/product-headphones.jpg')}}" alt="product">
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content product-name"><img src="{{asset('backend/assets/img/product-shoes.jpg')}}" alt="product">
                                            <div class="align-self-center">
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content product-name"><img src="{{asset('backend/assets/img/product-watch.jpg')}}" alt="product">
                                            <div class="align-self-center">
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content product-name"><img src="{{asset('backend/assets/img/product-laptop.jpg')}}" alt="product">
                                            <div class="align-self-center">
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content product-name"><img src="{{asset('backend/assets/img/product-camera.jpg')}}" alt="product">
                                            <div class="align-self-center">
